...
class HospitalTest {
    ...
    void testAddDuplicateSectionThrowsException() {
        ...
        try {
            hospital.addSection(section1); // First addition is successful
        ...
        DuplicateInfoException exception = assertThrows(DuplicateInfoException.class, () -> {
            hospital.addSection(section1); // Same section is added again
        });

        assertEquals("This section already exists in the hospital!", exception.getMessage());
    }
}